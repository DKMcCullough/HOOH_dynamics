...
for (t,nt) in zip(treats,range(ntreats)):
    ...
    fig1.suptitle('Het Data in '+ str(t)) #full title config
    ax1[0,0].set_title('Heterotroph Cell Concentration')
    ...
    fig2.suptitle('Het Logged Data in '+ str(t)) #full title config
    ax2[0,0].set_title('Logged Het Cell Concentration')
...
plt.show() 
#fig1.savefig('../figures/Het_raw_graphs')
#fig2.savefig('../figures/Het_logged_graphs')
