...
name:   model_cat_muts_ace_abiotic.py 
...
inits0 = pd.read_csv("../data/inits/MHMace_abiotic0.csv")
...
fig1.savefig('../figures/MHMace_abiotic_0_dynamics')
...
#print out plot
fig2.savefig('../figures/MHMace_abiotic_0_TRACE')
...
#print out plot
fig3.savefig('../figures/MHMace_abiotic_0_residuals')

plt.show()


pframe0 = pd.DataFrame(a0.get_parameters(),columns=a0.get_pnames())
pframe0.to_csv("../data/inits/MHMace_abiotic0.csv")
...
##################################
df = df15
inits15 = pd.read_csv("../data/inits/MHMace_abiotic1500.csv")
...
#plot dynamics of data and model for 0 assay 
ax4[0].plot(df.time,df.abundance, marker='o',color = c15, label = 'H data ') #data of 0 H assay
...
fig4.savefig('../figures/MHMace_abiotic_1500_dynamics')
...
#print out plot
fig5.savefig('../figures/MHMace_abiotic_1500_TRACE')
...
#print out plot
fig6.savefig('../figures/MHMace_abiotic_1500_residuals')
...
pframe15.to_csv("../data/inits/MHMace_abiotic1500.csv")
