...
kdam_prior = ODElib.parameter(stats_gen=scipy.stats.lognorm,hyperparameters={'s':pw,'scale':0.000000000002})
...
posteriors4.to_csv('../data/posteriors/pos_syn_'+str(vol)+ 'nospike.csv')
