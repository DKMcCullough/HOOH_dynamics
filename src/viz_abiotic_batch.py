...
#setting working df as a single Experiment in df_all
    ...
    ax1[nt,1].text(1.1,0.5,str(t),horizontalalignment='center', verticalalignment='center', transform=ax1[nt,1].transAxes)
    ax1[nt,0].semilogy()
    ...
    ax2[nt,1].text(1.1,0.5,str(t),horizontalalignment='center', verticalalignment='center', transform=ax1[nt,1].transAxes)
    ax2[nt,0].semilogy()
    ax2[nt,1].semilogy()
    ax2[nt,1].semilogx()
