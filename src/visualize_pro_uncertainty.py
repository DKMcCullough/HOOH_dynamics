...
f1,ax = plt.subplots(1,2,figsize=[15,10],dpi = 300)
f1.suptitle('WH7803')
ax[1].plot(df.log_abundance,df.log_abundance_std)
ax[0].plot(df.abundance_mean,df.abundance_std)
ax[1].set_xlabel('logged mean')
ax[1].set_ylabel('logged standard deviation')
ax[0].set_xlabel('unlogged mean')
ax[0].set_ylabel('unlogged standard deviation')
ax[0].semilogy()
ax[1].semilogy()
